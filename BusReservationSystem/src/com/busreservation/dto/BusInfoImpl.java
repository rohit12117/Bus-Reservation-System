...
public class BusInfoImpl implements BusInfo {
	...
	public String toString() {
		...
		double availability = ((double) booked_seats / total_seats )  * 100;

		String col = Colors.GREEN ;
		if( availability <= 60 ){
			col = Colors.GREEN;
		}
		else if( availability > 60 &&  availability <= 90){
			col = Colors.YELLOW;
		}
		else col = Colors.RED ;
		 String val = "Bus Number: " + busNo + "\n" 
	                 ...
	                 +"Avaliable_seats: " + avaliable_seats + col + "\n"
				     +"Departure: " + departure + "\n" 
				     +"Arrival: " + arrival + "\n" 
				     +"Fare: " + fare + "\n";
